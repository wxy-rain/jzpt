<template>
  <div class="category">
    ...
    <div class="select">
      <el-input v-model="list.name" clearable="true" placeholder="请输入栏目名称" />
      <div class="btn">
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px" size="small">
        <el-form-item label="栏目名称" prop="name">
          <el-input v-model="form.name" clearable="true" placeholder="请输入栏目名称" />
        </el-form-item>
        <el-form-item label="序号" prop="num">
          <el-input v-model="form.num" clearable="true" placeholder="请输入序号" />
        </el-form-item>
